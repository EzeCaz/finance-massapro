        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative flex items-center justify-center min-h-[340px] sm:min-h-[440px] lg:min-h-[500px]">
                {/* Ambient glow behind brain */}
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <div className="w-[70%] h-[70%] rounded-full bg-purple-600/20 blur-[80px]" />
                </div>

                {/* Rotating Brain Video - mix-blend-mode: screen makes black bg transparent */}
                <motion.video
                  autoPlay
                  loop
                  muted
                  ...
                  className="w-[65%] max-w-[400px] h-auto mix-blend-screen drop-shadow-[0_0_80px_rgba(147,51,234,0.6)]"
                >
